...
### Changed
- Bump appVersion from 26.7.3 to 26.7.4 (refresh templates/crd-*.yaml from upstream)

## [v0.2.3] - 2026-09-07

### Changed
- Bump appVersion from 26.7.2 to 26.7.3 (refresh templates/crd-*.yaml from upstream)

## [v0.2.2] - 2026-08-24

### Changed
- Bump appVersion from 26.7.1 to 26.7.2 (refresh templates/crd-*.yaml from upstream)

## [v0.2.1] - 2026-08-10

### Changed
- Bump appVersion from 26.7.0 to 26.7.1 (refresh templates/crd-*.yaml from upstream)
