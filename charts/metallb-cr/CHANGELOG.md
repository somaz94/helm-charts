...
### Changed
- Refactor values.schema.json to reuse $defs.stringMap and $defs.specExtra (no validation change), matching the keycloak-cr/keycloak-operator schema convention.
