...
### Added
- Add checksum/config and checksum/secret pod annotations to the bundled MySQL and Ghost Deployments so mysql config or credential changes trigger a rollout on helm upgrade.
