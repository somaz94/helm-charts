...
# release and bump Chart.yaml `appVersion`. The chart is bring-your-own-image;
# values.yaml is not touched (VALUES_FILE=""). CONTAINER_IMAGE is empty because
# upstream does not publish a reference image — consumers build their own.
set -euo pipefail

# ============================================================
# Configuration — per chart
# ============================================================
SCRIPT_NAME="unity-mcp-server Helm Chart appVersion Bump"
COMPONENT_LABEL="unity-mcp"
VERSION_SOURCE="github-release"
VERSION_SOURCE_ARG="CoplayDev/unity-mcp"
MAJOR_PIN=""
CHANGELOG_URL="https://github.com/CoplayDev/unity-mcp/releases"
CONTAINER_IMAGE=""
TAG_SUFFIX=""
VALUES_FILE=""
VERSION_KEY=""
